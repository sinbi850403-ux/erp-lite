...
function loadSampleData(navigateTo) {
  const sampleData = [
    ['품목명', '품목코드', '분류', '수량', '단위', '단가', '합계금액', '창고', '비고'],
    ['A4용지', 'P-001', '사무용품', 500, 'EA', 5000, 2500000, '본사 1층', ''],
    ['볼펜(청)', 'P-002', '사무용품', 200, 'EA', 800, 160000, '본사 1층', ''],
    ['복사기 토너', 'P-003', '소모품', 10, 'EA', 45000, 450000, '본사 2층', '정기교체'],
    ['모니터 24인치', 'E-001', '전자기기', 15, 'EA', 250000, 3750000, '본사 2층', '신규 입고'],
    ['키보드(무선)', 'E-002', '전자기기', 30, 'EA', 35000, 1050000, '본사 2층', ''],
    ['커피원두 1kg', 'F-001', '식음료', 20, 'KG', 15000, 300000, '휴게실', ''],
    ['정수기 필터', 'F-002', '소모품', 5, 'EA', 25000, 125000, '휴게실', '6개월 교체'],
    ['택배상자(소)', 'W-001', '포장재', 300, 'EA', 500, 150000, '물류창고', ''],
    ['택배상자(중)', 'W-002', '포장재', 200, 'EA', 800, 160000, '물류창고', ''],
    ['택배상자(대)', 'W-003', '포장재', 100, 'EA', 1200, 120000, '물류창고', ''],
    ['에어캡', 'W-004', '포장재', 50, 'M', 2000, 100000, '물류창고', ''],
    ['노트북 충전기', 'E-003', '전자기기', 10, 'EA', 45000, 450000, '본사 1층', ''],
    ['화이트보드 마커', 'P-004', '사무용품', 100, 'EA', 1500, 150000, '본사 1층', '4색 세트'],
    ['포스트잇', 'P-005', '사무용품', 150, 'EA', 2000, 300000, '본사 1층', ''],
  ];
